    ...
    <div style={{ backgroundColor: '#FAF6F0', minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .off-section { flex-direction: column !important; padding: 40px 24px !important; }
          .off-section-reverse { flex-direction: column !important; padding: 40px 24px !important; }
          .off-image { width: 100% !important; height: 280px !important; }
          .off-navbar { padding: 16px 24px !important; }
          .off-nav-links { gap: 16px !important; }
          .off-nav-links a { font-size: 12px !important; }
          .off-hero { padding: 40px 24px 20px !important; }
          .off-headline { font-size: 32px !important; }
        }
      `}</style>

      {/* NAVBAR */}
      <nav className="off-navbar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 60px', backgroundColor: '#FAF6F0' }}>
        <h1 style={{ color: '#B8D4C8', fontSize: '22px', letterSpacing: '4px', margin: 0, fontWeight: 'bold' }}>
          TRIBE GNOSIS
        </h1>
        <div className="off-nav-links" style={{ display: 'flex', gap: '32px' }}>
      ...
      {/* HERO */}
      <section className="off-hero" style={{ textAlign: 'center', padding: '80px 60px 40px' }}>
        <p style={{ color: '#F2C4CE', fontSize: '12px', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '16px' }}>
          What We Offer
        </p>
        <h2 className="off-headline" style={{ color: '#B8D4C8', fontSize: '48px', fontWeight: 'bold', margin: '0 0 20px 0' }}>
      ...
      {/* MOVE */}
      <section className="off-section" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '60px', padding: '60px', backgroundColor: '#fff' }}>
        <div style={{ flex: 1 }}>
        ...
        <div className="off-image" style={{ flex: 1, height: '420px', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.1)' }}>
          <img src="/yoga.jpg" alt="Yoga and meditation" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      </section>

      {/* GLOW */}
      <section className="off-section-reverse" style={{ display: 'flex', flexDirection: 'row-reverse', alignItems: 'center', gap: '60px', padding: '60px', backgroundColor: '#FAF6F0' }}>
        <div style={{ flex: 1 }}>
