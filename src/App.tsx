...
function App() {
  ...
  return (
    <div style={{ backgroundColor: '#FAF6F0', minHeight: '100vh', fontFamily: 'Georgia, serif', margin: 0, padding: 0 }}>
      ...
      {/* APPAREL */}
      <section style={{ padding: isMobile ? '40px 24px' : '80px 60px', backgroundColor: '#fff' }}>
        <div style={containerStyle}>
          <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', justifyContent: 'space-between', gap: '60px' }}>
            <div style={{ flex: 1 }}>
              <p style={{ color: '#D4849A', fontSize: '12px', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '16px' }}>
                Coming Soon
              </p>
